...
class Leaderboard {
    ...
    var valueMap: HashMap<Long, Pair<Int, Float>> = HashMap()
        private set
    //rankMap[Rank]=id
    ...
    fun getOrDefault(id: Long, def: Float): Float {
    ...
    fun setValue(id: Long, newValue: Float): LeaderboardChange {
    ...
    private fun newEntry(id: Long, newValue: Float) {
    ...
    private fun moveUpInLeaderboard(id: Long, newValue: Float): LeaderboardChange {
    ...
    private fun moveDownInLeaderboard(id: Long, newValue: Float): LeaderboardChange {
        var rank = valueMap[id]!!.key
